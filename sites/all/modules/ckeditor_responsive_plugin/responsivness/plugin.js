  ...
  CKEDITOR.plugins.add('responsivness', {
    ...
    init: function (editor) {
      ...
      editor.addCommand('beResponsive', new CKEDITOR.dialogCommand('beResponsive', {
        allowedContent: ' div(ckeditor-col-container,first-col,last-col,onecol,twocol,threecol,fourcol,fivecol,sixcol,sevencol,eightcol,ninecol,tencol,elevencol,twelvecol,grid-1,grid-2,grid-3,grid-4,grid-5,grid-6,grid-7,grid-8,grid-9,grid-10,grid-11,grid-12,medium-4,medium-6,medium-8,small-12,columns,row)'
      }));
