...
function responsiveness_get_template(tpl) {
  ...
  switch (tpl) {
    case '1_100':
      grid = '<div class="ckeditor-col-container row row clearfix">';
      grid += '<div class="grid-12 twelvecol first-col small-12 columns"><p>lorem ipsum</p></div>';
      grid += '</div><br />';
      break;

    case '2_50_50':
      grid = '<div class="ckeditor-col-container row clearfix">';
      grid += '<div class="grid-6 medium-6 columns sixcol first-col"><p>lorem ipsum</p></div>';
      grid += '<div class="grid-6 medium-6 columns sixcol last-col"><p>lorem ipsum</p></div>';
      grid += '</div><br />';
      break;

    case '2_75_25':
      grid = '<div class="ckeditor-col-container row clearfix">';
      grid += '<div class="grid-8 medium-8 columns eightcol first-col"><p>lorem ipsum</p></div>';
      grid += '<div class="grid-4 medium-4 columns fourcol last-col"><p>lorem ipsum</p></div>';
      grid += '</div><br />';
      break;

    case '2_25_75':
      grid = '<div class="ckeditor-col-container row clearfix">';
      grid += '<div class="grid-4 medium-4 columns fourcol first-col"><p>lorem ipsum</p></div>';
      grid += '<div class="grid-8 medium-8 columns eightcol last-col"><p>lorem ipsum</p></div>';
      grid += '</div><br />';
      break;
    ...
    case '3_33_34_33':
      grid = '<div class="ckeditor-col-container row clearfix">';
      grid += '<div class="grid-4 medium-4 columns fourcol first-col"><p>lorem ipsum</p></div>';
      grid += '<div class="grid-4 medium-4 columns fourcol"><p>lorem ipsum</p></div>';
      grid += '<div class="grid-4 medium-4 columns fourcol last-col"><p>lorem ipsum</p></div>';
      grid += '</div><br />';
      break;
  }
